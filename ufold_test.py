...
MODEL_SAVED = '/data2/darren/experiment/ufold/models_ckpt/final_model/unet_train_on_merge_alldata_99.pt'
...
#from e2efold.data_generator import Dataset_Cut_input as Dataset_FCN
...
#from e2efold.data_generator import Dataset_Cut_8 as Dataset_FCN
#from e2efold.data_generator import Dataset_Cut_concat as Dataset_FCN
import collections
...
test_data = RNASSDataGenerator('/data2/darren/experiment/ufold/data/', 'test_600.pickle')
...
#     for contacts, seq_embeddings, matrix_reps, seq_lens, seq_ori in train_generator:
